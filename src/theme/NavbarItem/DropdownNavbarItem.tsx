...
const navbarIcons: Record<string, React.ReactNode> = {
  ...
  'LucidNet': (
    <svg className="dropdown__link-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M6 7l4.5 3.5M14.5 10.5L18 7M6 17l4.5-3.5M14.5 13.5L18 17" />
    </svg>
  ),
  'Get Started': (
    <svg className="dropdown__link-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  'Forum (Discord)': (
    <svg className="dropdown__link-icon" viewBox="0 0 24 24" fill="currentColor">
...
function addIconsToItems(items: readonly any[]): any[] {
...
export default function DropdownNavbarItemWrapper(props: Props): JSX.Element {
  const modifiedProps = {
    ...props,
    items: addIconsToItems(props.items || []),
  };
