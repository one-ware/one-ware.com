            ...
            rows: [
                {
                    date: "2025-10-23",
                    city: "Florence, Italy",
                    venue: "Arrow Office, Via Sandro Pertini 95, Sesto Fiorentino (FI)"
                },
                {
                    date: "2025-11-13",
                    city: "Bologna, Italy",
                    venue: "Arrow Office, Via Marabini 3, 40013 Castel Maggiore (BO)"
                }
            ]
        },
        {
            ...
            rows: [
                {date: "2025-11-18", city: "Marlow, UK", venue: "Altera Marlow, Eclipse Parkway, Marlow, SL7 1YL"},
                {
                    date: "2025-11-19",
                    city: "Cambridge, UK",
                    venue: "Airborne Assault Ltd, Duxford Airfield, Duxford CB22 4QR"
                }
            ]
        },
        {
        ...
        },
        {
            ...
            rows: [
                ...
                {date: "2025-11-13", city: "Dortmund, Germany", venue: "Hildebrandstrasse 11, 44319 Dortmund"},
                {
                    ...
                    venue: "Höpfigheimer Strasse 5, 74321 Bietigheim-Bissingen"
                },
                ...
                {date: "2025-12-02", city: "Freiburg, Germany", venue: "Am Gansacker 10, 79224 Freiburg"},
                {
                    date: "2025-12-09",
                    city: "Berlin, Germany",
                    venue: "Eurostars Berlin, Friedrichstrasse 99, 10117 Berlin"
                },
            ...
            rows: [
                {
                    date: "2025-09-30",
                    city: "Portland, USA",
                    venue: "Office Evolution, 9620 NE Tanasbourne St Suite 300, Hillsboro, OR"
                },
                {
                    date: "2025-10-07",
                    city: "Denver, USA",
                    venue: "Arrow Office, 9151 E. Panorama Circle, Centennial, CO"
                },
                {
                    date: "2025-10-08",
                    city: "Minneapolis, USA",
                    venue: "Arrow Office, 10900 Hampshire Ave. S, Suite 180, Bloomington, MN"
                },
                {
                    date: "2025-10-15",
                    city: "Atlanta/Raleigh, USA",
                    venue: "Forum Assembly Room, 1125 Sanctuary Pkwy #120, Alpharetta, GA"
                },
                {
                    date: "2025-10-16",
                    city: "Orlando, USA",
                    venue: "Trailblazer Meeting & Event Space, 3801 Avalon Park East Blvd, FL"
                },
                {
                    date: "2025-10-21",
                    city: "Dallas, USA",
                    venue: "Hexa Co-Working, 2100 North Greenville Ave, Richardson, TX"
                },
                {
                    date: "2025-10-22",
                    city: "San Diego, USA",
                    venue: "Venture X, 10089 Willow Creek Road, Suite 200, San Diego, CA"
                },
                {
                    date: "2025-10-23",
                    city: "Seattle, USA",
                    venue: "Venture Mechanics Co, Airbus room, 14110 NE 21st St, Bellevue, WA"
                },
                {
                    date: "2025-10-28",
                    city: "Philadelphia, USA",
                    venue: "Sentient Liquid Space, 1000 Northbrook Dr, Trevose, PA"
                },
                {
                    date: "2025-10-29",
                    city: "Baltimore, USA",
                    venue: "Sheraton Rockville, 920 King Farm Blvd., Rockville, MD"
                },
                {date: "2025-10-30", city: "St. Louis/KC, USA", venue: "Remote / Virtual Only"},
                {
                    date: "2025-11-04",
                    city: "Montreal, Canada",
                    venue: "Novatel Montreal Airport, 2599 Alfred Noble, QC"
                },
                {date: "2025-11-05", city: "San Jose, USA", venue: "Arrow Office, 181 Metro Drive, Suite 180, CA"},
                {
                    date: "2025-11-06",
                    city: "Chicago, USA",
                    venue: "Arrow Office, 2001 Butterfield Dr., Suite 1800, Downers Grove, IL"
                },
                {
                    date: "2025-11-11",
                    city: "Rochester, USA",
                    venue: "Spot Cowork, 600 Fishers Station Drive, Victor, NY"
                },
                {
                    date: "2025-11-12",
                    city: "Los Angeles, USA",
                    venue: "Arrow Office, 21700 W Oxnard St, Suite 750, Woodland Hills, CA"
                },
                {date: "2025-11-13", city: "Toronto, Canada", venue: "Location TBD"},
                {
                    date: "2025-11-18",
                    city: "Calgary, Canada",
                    venue: "Smart Executive Center, 1925-18th Ave. NE, Suite 115, AB"
                },
                {
                    date: "2025-11-19",
                    city: "Boston, USA",
                    venue: "Office Evolution, 2 Burlington Woods Dr, Suite 100, Burlington, MA"
                },
