...
export default memo(function ConveyorBelt({
  isActive,
  showStation = true,
  onScan,
  speedMultiplier = 1.0,
    ...
    const animate = (time: number) => {
      ...
      for (let i = applesRef.current.length - 1; i >= 0; i--) {
        ...
        if (apple.rejected) {
          ...
          apple.rejectOpacity = Math.max(
            0,
            apple.rejectOpacity - safeDelta * 4
          );
        } else {
          apple.x += moveDist;
        }
      ...
      >
        <defs>
          ...
          <clipPath id="belt-clip">
            <rect x="0" y={BELT_Y} width="800" height="12" />
          </clipPath>
        </defs>
        ...
        <g
          ...
          style={{
            ...
            transform:
              animStage >= 2
                ? `translate(${PUSHER_X}px, 215px) translateY(0)`
                : `translate(${PUSHER_X}px, 215px) translateY(-30px)`,
        ...
        >
          ...
          <circle
            ...
            cy="18"
            r="2"
            fill={pusherExtended ? "#ef4444" : "#22c55e"}
          >
            {isRunning && (
              <animate
        ...
        <g
          style={{
            ...
            transform: animStage >= 1 ? "scaleX(1)" : "scaleX(0)",
        ...
        {apples.map((apple) =>
          performanceTier === "low" ? (
            <g
              key={apple.id}
              transform={`translate(${apple.x}, ${apple.y})`}
              opacity={apple.rejectOpacity}
            >
              <circle
                r={APPLE_RADIUS * 0.9}
                fill={apple.isRotten ? "#4a442a" : "#dc2626"}
              />
              <path
                d="M0,-15 Q2,-20 5,-22"
                stroke="#3f2c08"
            ...
            >
              <g transform={`rotate(${apple.rejected ? apple.rotation : 0})`}>
                ...
                <g transform="scale(0.9)">
                  <circle
                    ...
                    r={APPLE_RADIUS}
                    fill={apple.isRotten ? "#4a442a" : "#dc2626"}
                    stroke={apple.isRotten ? "#2c281a" : "#7f1d1d"}
                    strokeWidth="1"
                  />
                  <circle
                    cx="-5"
                  ...
                  {apple.isRotten ? (
                    <path
                      d="M-10,-5 Q0,5 10,-2 Q5,10 -5,8 Z"
                      fill="#2c281a"
                      opacity="0.8"
                    />
                  ) : (
                  ...
                  />
                  <path
                    d="M0,-16 Q-12,-22 0,-28 Q12,-22 0,-16"
                    fill={apple.isRotten ? "#3f6212" : "#22c55e"}
                  />
                </g>
              </g>
              ...
              {apple.rejected && apple.rejectTime < 0.15 && (
                <circle
                  cx="0"
                  cy="0"
                  r={APPLE_RADIUS + 10 + apple.rejectTime * 100}
                  stroke="#ef4444"
                  strokeWidth="2"
                  fill="none"
                  opacity={1 - apple.rejectTime / 0.15}
                />
              )}
            </g>
          )
