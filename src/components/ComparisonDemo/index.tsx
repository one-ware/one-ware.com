...
function ExampleSelector({
  ...
  return (
    <div
      ref={containerRef}
      className="relative flex flex-col p-1.5 rounded-2xl bg-gray-50/80 dark:bg-white/[0.03] border backdrop-blur-sm self-center"
      ...
      {EXAMPLES.map((ex, index) => {
        ...
        return (
          <button
            ...
            className={`relative z-10 flex flex-col items-center justify-center gap-1.5 px-3 py-3 md:px-4 md:py-4 rounded-xl transition-all duration-300 border-0 bg-transparent cursor-pointer ${
              isActive
