...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[9999] w-[calc(100%-2rem)] max-w-3xl">
      <div className="cookie-banner px-5 py-4 shadow-2xl backdrop-blur-xl">
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="flex gap-2 flex-shrink-0">
            <button
              ...
              className="cookie-banner__btn-secondary group relative px-4 py-2 font-medium text-sm overflow-hidden transition-all duration-300"
            >
            ...
            <button
              onClick={acceptAll}
              className="cookie-banner__btn-primary group relative px-4 py-2 font-medium text-sm overflow-hidden transition-all duration-300"
            >
