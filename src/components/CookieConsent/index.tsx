...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[9999] w-[calc(100%-2rem)] max-w-3xl">
      <div
        className="rounded-xl px-5 py-4 shadow-2xl backdrop-blur-xl"
        style={{
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div className="flex gap-2 flex-shrink-0">
            <button
              ...
              className="group relative px-4 py-2 rounded-lg font-medium text-sm overflow-hidden transition-all duration-300"
              style={{
