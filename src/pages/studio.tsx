        ...
        <div className="flex-col flex text-center">
          ...
          <div className="grid grid-cols-2 md:flex gap-5 md:flex-wrap justify-center">
            <a href="/docs/studio/setup?current-os=windows" className="md:contents">
              <div className="flex-col w-full md:w-48 h-32 md:h-auto p-4 md:p-6 border shadow opacity-90 text-center dark:bg-black dark:bg-opacity-50 bg-white bg-opacity-50 md:backdrop-blur-sm cursor-pointer md:cursor-default hover:opacity-100 transition-opacity flex justify-center items-center">
