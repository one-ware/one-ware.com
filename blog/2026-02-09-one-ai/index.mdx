...
**The Result:** In our benchmarks, this approach achieved an **F1-Score of 95.7%** compared to just **56% with YOLOv8**, resulting in **10x fewer errors** while using significantly less compute. (Result: 95.7 F1 vs 56.0 with YOLOv8 on our benchmark — [details here](/docs/one-ai/demos/multi-image-demo))
