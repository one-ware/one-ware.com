...
This documentation goes beyond the [basic C# SDK documentation](/docs/guides/deployment/csharp-onnx-sdk and helps you to understand the design to customize it according to your project requirements.
...
To learn more about OneAI or OneWare Studio, check out the [documentation](/docs/reference/overview). 
