...
sidebar_label: Object Detection with Small Datasets
---
...
To keep it short, we just point out the values we used for the following settings with a brief explanation of why we chose these values. For further details about the augmentations or prefilters, please refer to the [documantation](/docs/reference/filters-and-augmentations) or previous tutorials. 
...
- **Move Augmentation**: We shift the picture by **±20%** in both directions. Ensure that the print does not move out of the white preview box to get the best results. 
...
- **Resize Augmentation**: Here we choose a value of **±20%** to have examples at different scales. 
- **Color Augmentation**: We set the **Brightness** and **Contrast** to **±10** and the **Saturation** to **±20** to mimic changes in the lighting conditions.
