...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
  <Link className="button button--primary button--lg" href="/docs/tutorials/teacup-print-detection">
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
  <Link className="button button--primary button--lg" href="/docs/tutorials/potato-chip-demo">
    <p className="m-0 p-0">Check out Demo</p>
  </Link>
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
  <Link className="button button--primary button--lg" href="/docs/tutorials/difference-image-demo">
    <p className="m-0 p-0">Check out Demo</p>
  </Link>
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', gap: '1rem', flexWrap: 'wrap' }}>
  <Link className="button button--primary button--lg" href="/docs/tutorials/bd3-building-defects-detection-demo">
    <p className="m-0 p-0">Check out Demo</p>
  </Link>
</div>