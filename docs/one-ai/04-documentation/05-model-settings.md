...
We have a [guide on choosing the right parameters](/docs/one-ai/getting-started/choosing-parameters-guide), which explains the settings using different example tasks. If you're unsure whether your settings are correct, this is a great place to learn more.
...
Check out our [guide on choosing the right parameters](/docs/one-ai/getting-started/choosing-parameters-guide).
:::
