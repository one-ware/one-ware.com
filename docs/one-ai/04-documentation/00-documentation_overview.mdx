...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem' }}>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/dataset">
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem' }}>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/hardware-settings">
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap' }}>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/filters-and-augmentations#prefilters">
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap' }}>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/filters-and-augmentations#augmentations">
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap', marginTop: '2rem' }}>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/model-settings">
    <p className="m-0 p-0">Model Settings Guide</p>
  </Link>
  <Link className="button button--primary button--lg" href="/docs/one-ai/getting-started/choosing-parameters-guide">
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem' }}>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/training">
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', gap: '2rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/export">
    <p className="m-0 p-0">Model Export Guide</p>
  </Link>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/integration/documentation-cpp-api">
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem' }}>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/camera-tool">
...
<div className="text--center" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '2rem' }}>
  <Link className="button button--primary button--lg" href="/docs/one-ai/documentation/dataset#5-using-a-trained-model-to-annotate-new-data">
