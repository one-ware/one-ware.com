---
id: csharp-onnx-sdk-advanced
title: C# ONNX SDK Advanced
sidebar_label: C# ONNX SDK (advanced)
---

## Architectural design

This documentation goes beyond the [basic C# SDK documentation](/docs/one-ai/documentation/integration/csharp-onnx-sdk) and helps you to understand the design to customize it according to your project requirements.
...
To learn more about OneAI or OneWare Studio, check out the [documentation](/docs/one-ai/documentation/overview). 
