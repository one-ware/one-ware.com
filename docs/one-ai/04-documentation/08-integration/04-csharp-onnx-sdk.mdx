...
+ customizable through the configuration property in the ```OnnxModel```. Within this property the api consumer is able to specify
his own ```IOnnxImageProcessor``` as well as override the default ```OnnxPrediction``` for full control of data processing.

## Architectural design 

This diagrams shows the data flow regarding to the prediction process.

![Prediction Flow](OneWare.AI.Onnx_Flow.svg)
...
If this package isn't working the way you expect, or you have questions in generally, don't hesitate to get in touch with us
