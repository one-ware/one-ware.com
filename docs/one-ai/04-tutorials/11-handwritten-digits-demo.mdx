...
## Training the model
[🔗 training settings guide](/docs/one-ai/getting-started/training-and-export#training-a-new-ai-model)  
...
## Testing the model
[🔗 camera tool guide](/docs/one-ai/getting-started/camera-tool)  
