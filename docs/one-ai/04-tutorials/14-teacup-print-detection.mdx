...
- **Rotate Augmentations**: Our goal is to detect the print in almost every kind of appearance including rotations so we set let the image rotate from **-180** to **180°**.
