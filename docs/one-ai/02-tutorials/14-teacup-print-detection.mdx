...
To keep it short, we just point out the values we used for the following settings with a brief explanation of why we chose these values. For further details about the augmentations or prefilters, please refer to the [documantation](/docs/one-ai/01-getting-started/30-filters-and-augmentations.md) or previous tutorials. 
