...
## Model settings
[🔗 model settings guide](../getting-started/model-settings)  
### Output settings
...
The model input settings help the AI understand your detection requirements. For detailed explanations of these parameters, refer to the [model settings guide](../getting-started/model-settings).
...
## Hardware settings
[🔗 hardware settings guide](../getting-started/hardware-settings)  
