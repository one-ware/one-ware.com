...
For a detailed tutorial on how to obtain and use the VHDL model check out the [VHDL Demo](/docs/one-ai/tutorials/vhdl-demo). Further implementation help for integration into your FPGA project can be found in the [VHDL documentation](/docs/one-ai/export/documentation-vhdl).
