...
sidebar_label:  Supported Vendors
---
...
:::important
 **ONE AI works with all chip vendors. Next to tailored AI model generation for dedicated hardware, we are also providing standard outputs (e.g. ONNX, TF Lite) that can be used in almost any toolchain.**
