...
The model input settings help the AI understand your detection requirements. For detailed explanations of these parameters, refer to the [model settings guide](/docs/one-ai/documentation/model-settings).
