...
If you can't install snap on your machine, it is possible to download the binaries manually [here](https://cdn.one-ware.com/onewarestudio/) (select the .tar.gz version for universal linux support). Please note that as of now these binaries have no update functionality, so make sure to check for updates regularly. A flatpak version is planned!
